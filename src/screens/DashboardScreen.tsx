...
const DashboardScreen: React.FC = () => {
	const { 
		...
		requestVisitVerification // kept in context for other screens
	} = useFarmerContext()
	const { user } = useAuth()
		...
		<main className="screen">
			...
			<section className="content">
				<div className="welcome-card">
					<h2 className="greeting">Hello, {(user?.name || farmerName).split(' ')[0]}!</h2>
				...
				{achievements.length > 0 && (
					<div className="recent-achievements">
						<div className="section-header">
							...
							<Link to="/analysis" className="btn btn-ghost btn-text">View All</Link>
						</div>
